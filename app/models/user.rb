class User < ApplicationRecord
  ...
  # 本人情報確認
  with_options presence: { message: "can't be blank" }, format: { with: /\A[ぁ-んァ-ン一-龥]/, message: 'Full-width characters' } do
    validates :first_name
    validates :last_name
  end

  with_options presence: { message: "can't be blank" }, format: { with: /\A[ァ-ヶー－]+\z/, message: 'Full-width katakana characters' } do
